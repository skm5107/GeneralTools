classdef Tbl
    ...
    methods (Static)
        ...
        function new = cellfun(fcn_hndl, orig_tbl, uni_tf)
            orig_cell = table2cell(orig_tbl);
            new_cell = cellfun(fcn_hndl, orig_cell, 'UniformOutput', uni_tf);
            new = cell2table(new_cell);
        end
