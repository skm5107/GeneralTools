%% Figure Style from sdf
function sdf(varargin)
%sdf(fig,'stylename')
%sdf found here: https://www.mathworks.com/matlabcentral/fileexchange/24807-sdf-set-the-figure
